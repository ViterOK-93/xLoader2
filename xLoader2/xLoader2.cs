// Copyright (C) 2021-2026 Artur Kurpukov
...
[assembly: AssemblyProduct("xLoader2")]
...
class xLoader2 : Form {
    ...
    public const string AppDescription = "A utility for loading HEX files into Arduino Uno, Nano and MEGA2560 boards";
    public const string AppVersion = "2.1.1";
    public const string AppVersionBuild = "2026-06-16";
    public const string AppAuthor = "Artur Kurpukov";
    public const string AppCopyright = "Copyright (C) 2021-2026 Artur Kurpukov";
    
    private readonly IContainer _components = new Container();
    
    private readonly SerialPort _serialPort1;
    
    private struct AVRPart {
        public int signature;
        public int pageSize;
        public int flashSize;
        public string name;
        
        public AVRPart(int signature, int pageSize, int flashSize, string name = null) {
    ...
    private readonly AVRPart[] _avr_parts = new AVRPart[] {
        new AVRPart(0x1e950F, 128, 32768, "ATmega328P"),
        new AVRPart(0x1e9801, 256, 262144, "ATmega2560"),
        new AVRPart(0x1e9705, 256, 131072, "ATmega1284P"),
    };
    ...
    private void Button3Click(object sender, EventArgs e) {
        string s = (
            AppTitle+" v"+AppVersion+" ("+AppVersionBuild+")\n\n"+
            AppCopyright+"\n"
        );
    ...
    private void Button4Click(object sender, EventArgs e) {
        Process.Start("https://github.com/ViterOK-93/xLoader2");
    }
            ...
            if (jj == -1) {
                ...
                for (int addr = -4, k = 0;;) {
                    ...
                    if (addr < -3) {
                        ...
                        if (addr == 0) {
                            foreach (AVRPart avr_part in _avr_parts) {
                                if (avr_part.signature == signature) {
                                    page_size = avr_part.pageSize;
                                    break;
                                }
                            }
